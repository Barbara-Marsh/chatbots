...
<head>
    ...
    <title>Privacy Policy - V/Line Next Five Departures</title>
...
<div class="container">
    <header class="header">
        <figure class="header-figure">
            <img src="../img/google-actions/vline/vlineheader.jpg" style="max-width: 100%">
        </figure>
    </header>
    <h1>Privacy Policy</h1>
    <p> Barbara Marsh built the V/Line Next Five Departures app as a Free app. This SERVICE is provided by Barbara Marsh
    ...
    <p>The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible
        at V/Line Next Five Departures unless otherwise defined in this Privacy Policy.</p>
    <p><strong>Information Collection and Use</strong></p>
    <p>For a better experience, while using our Service, I may require you to provide us with certain personally
        identifiable information. The information that I request is retained on your device and is not collected by me
        in any way</p>
    ...
    <p>Cookies are files with small amount of data that is commonly used an anonymous unique identifier. These are sent
        to your browser from the website that you visit and are stored on your device internal memory.</p>
